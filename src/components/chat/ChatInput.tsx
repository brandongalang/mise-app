    ...
    return (
        <>
            <div className="px-4 pb-2">
                            ...
                            {attachments.map((att, i) => (
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        className="absolute -top-1.5 -right-1.5 w-5 h-5 bg-destructive text-destructive-foreground rounded-full flex items-center justify-center shadow-md opacity-0 group-hover:opacity-100 transition-opacity"
                                    >
                                        <X size={12} />
                                    </button>
                                </motion.div>
                ...
                <motion.div
                    className={cn(
                        "flex items-end gap-2 bg-muted/50 rounded-2xl p-2 transition-all duration-200",
                        "border-2 shadow-sm",
                        isFocused
                ...
                >
                    ...
                    <textarea
                        ...
                        className={cn(
                            ...
                            "resize-none text-base text-foreground font-sans",
                ...
                {/* Hint text */}
                <p className="text-center text-xs text-muted-foreground mt-2 font-sans">
